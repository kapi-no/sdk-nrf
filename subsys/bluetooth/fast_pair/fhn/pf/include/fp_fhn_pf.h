...
#ifndef _FP_FHN_PF_H_
#define _FP_FHN_PF_H_
...
/**
 * @defgroup fp_fhn_pf Fast Pair FHN Precision Finding
 * @brief Internal API for Fast Pair FHN Precision Finding that manages the
...
#define FP_FHN_PF_RANGING_CAPABILITY_RSP_MAX_LEN (47U)

/** Length of the Ranging Configuration Response. */
#define FP_FHN_PF_RANGING_CONFIG_RSP_LEN (4U)

/** Length of the Stop Ranging Response. */
#define FP_FHN_PF_STOP_RANGING_RSP_LEN (4U)
 ...
 *  format follows the Android ranging specification for out-of-band (OOB) communication.
 *
 *  The FP_FHN_PF_RANGING_CAPABILITY_RSP_MAX_LEN constant can be used to define the
 ...
 *  follows the Android ranging specification for out-of-band (OOB) communication.
 *
 *  The FP_FHN_PF_RANGING_CONFIG_RSP_LEN constant can be used to define the length
 ...
 *  follows the Android ranging specification for out-of-band (OOB) communication.
 *
 *  The FP_FHN_PF_STOP_RANGING_RSP_LEN constant can be used to define the length
 *  of the output buffer.
 *
 * @param[in]  conn            Connection object representing the Initiator.
